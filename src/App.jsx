        ...
        {screen === "giris" && (
          <div style={{ background: "#111827", padding: 20, borderRadius: 20 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
              {["", "X", "XX"].map((k) => (
                <button key={k} onClick={() => setKontur(k)} style={{ padding: 12, borderRadius: 10, border: "none", background: kontur === k ? "#7c3aed" : "#374151", color: "white", fontWeight: "bold", cursor: "pointer" }}>{k === "" ? "Yok" : k === "X" ? "X" : "XX"}</button>
              ))}
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginBottom: 20 }}>
              {["Yok", "Biz Zon", "Onlar Zon", "Herkes Zon"].map((z) => (
                <button key={z} onClick={() => setZon(z)} style={{ padding: 12, borderRadius: 10, border: "none", background: zon === z ? "#06b6d4" : "#374151", color: "white", cursor: "pointer" }}>{z}</button>
              ))}
            </div>
